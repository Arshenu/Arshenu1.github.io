...
function categorySubMenuToggle() {
    var screenSize = windows.width();
    if ( screenSize <= 991) {
        $('.stroke .menu-item-has-children > a').prepend('<i class="expand menu-expand"></i>');
        $('.stroke .menu-item-has-children ul').slideUp();
...
//        })
        ...
        $('.stroke .menu-item-has-children > a i').remove();
        $('.stroke .menu-item-has-children ul').slideDown();
    }
}
categoryMenuToggle();
...
/*-- Category Sub Menu --*/
$('.stroke').on('click', 'li a, li a .menu-expand', function(e) {
